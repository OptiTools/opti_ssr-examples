...
<asdf
  ...
  <header>
    <name>Real reproduction setup</name>
    <description>
      This scene creates the preconditions for tracking the listener 
      inside this real reproduction setup located at Institut für Nachrichtentechnik, Uni Rostock.
    </description>
  </header>
